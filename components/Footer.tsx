    ...
    <footer id="contato" className="section bg-navy text-white">
      <div className="container grid md:grid-cols-3 gap-10">
        <div>
          ...
          <div className="mt-4 text-sm text-white/70">CNPJ: 51.675.274/0001-11</div>
        </div>
        <div>
        ...
        <div>
          ...
          <a className="btn-outline mt-3 inline-flex" href="https://wa.me/5521996283859?text=Quero%20conhecer%20a%20Unity%20Fitness" target="_blank">Chamar no Whatsapp</a>
        </div>
      </div>
